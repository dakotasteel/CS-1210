...
result = calc_discriminant(a, b, c)
if result > 0:
    root_one = (-b + math.sqrt(result))/(2 * a)
    root_two = (-b - math.sqrt(result))/(2 * a)
    print(f"The two roots of this equation are {root_one:.3f}  and  {root_two:.3f}")
elif result == 0:
    single_root = (-b / (2 * a))
